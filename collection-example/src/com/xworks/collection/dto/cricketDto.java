...
public class cricketDto implements Serializable {
    ...
    public cricketDto(String teamName, int numberOfPlayers, String ownerName, String sponser, double budget) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(teamName, numberOfPlayers, ownerName, sponser, budget);
    }
}
